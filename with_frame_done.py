...
import sip
from PyQt5.QtWidgets import QLabel, QHBoxLayout, QApplication, QFrame, QVBoxLayout, QWidget, QLineEdit, QTableWidget, QTableWidgetItem, QCheckBox
...
class Terminal(gr.top_block, Qt.QWidget):
    def __init__(self):
        ...
        self.active_channels_layout = QHBoxLayout(self.active_channels_frame)
        self.active_channels_frame.setFixedWidth(800)
        self.active_channels_frame.setStyleSheet("color: #ffffff;")  # Set background color to black and text color to white
        # self.active_channels_frame.setStyleSheet("background-color: green;")
        # Create a QTableWidget
        self.table_widget = QTableWidget()
        self.table_widget.setColumnCount(4)  # Set the number of columns to 4
        self.table_widget.setFixedWidth(screen_width//4)
        ...
        self.active_channels_layout.addWidget(self.table_widget, alignment=Qt.Qt.AlignCenter)
        ...
        self.google_map_layout = QHBoxLayout(self.google_map_frame)
        self.google_map_frame.setStyleSheet("background-color: white;") 
        ...
        # self.new_layout.addWidget(self.active_channels_frame)
        # self.new_layout.addWidget(self.google_map_frame)
        

        # # self.divided_layout.addWidget(self.google_map_frame)
        
        # self.top_layout.addWidget(self.new_frame)
        # # self.top_layout.addWidget(self.google_map_frame)
        # screen_width = QApplication.desktop().availableGeometry().width()
        # screen_height = QApplication.desktop().availableGeometry().height()
        ...
        # self.new_frame.setStyleSheet("background-color: white;")

        # Set the frame width to match the screen width
        self.new_frame.setFixedWidth(screen_width//2)
        self.active_channels_frame.setFixedWidth(screen_width//2)
        self.active_channels_frame.setFixedHeight(screen_height//5)
        self.google_map_frame.setFixedWidth(screen_width//2)

        self.bigframe = QFrame()
        self.biglayout = QHBoxLayout(self.bigframe)
        # self.bigframe.setStyleSheet("background-color: red;")

        self.bigframe.setFixedWidth(screen_width//2)
        self.bigframe.setFixedHeight(2* (screen_height//3))
        
        self.bigframe2 = QFrame()
        self.biglayout2 = QVBoxLayout(self.bigframe2)
        # self.bigframe2.setStyleSheet("background-color: orange")
        self.bigframe2.setFixedWidth(screen_width//2)
        self.bigframe2.setFixedHeight(2* (screen_height//3))
        

        self.large_frame = QFrame()
        self.large_layout = QHBoxLayout(self.large_frame)
        # self.large_frame.setStyleSheet("background-color: pink")
        self.large_frame.setFixedWidth(screen_width)
        self.large_frame.setFixedHeight(2* (screen_height//3))

        self.biglayout.addWidget(self.new_frame)
        self.biglayout2.addWidget(self.google_map_frame)
        self.large_layout.addWidget(self.bigframe)
        self.large_layout.addWidget(self.bigframe2)
        
        # Add widgets to the layout
        
        # self.new_layout.addWidget(self.google_map_frame)

        # Add the new frame to the top layout
        # self.top_layout.addWidget(self.new_frame)
    ...
    1024, window.WIN_BLACKMAN_hARRIS, 0, samp_rate, "", 1, None)
        ...
        # self._qtgui_waterfall_sink_x_0_win.setFixedSize(screen_width//2,200)

        # self.top_layout.addWidget(self._qtgui_waterfall_sink_x_0_win)
        self.new_layout.addWidget(self.active_channels_frame)
        self.new_layout.addWidget(self._qtgui_waterfall_sink_x_0_win)
        
        self.top_layout.addWidget(self.large_frame)
        ...
        self.checkbox_include_drone_detection.setStyleSheet("color: #fff0ff;")  # Set checkbox text color
        self.top_layout.addWidget(self.checkbox_include_drone_detection)

        # self.new_frame2 = self.QFrame()
        # self.new_frame_layout2 = QVBoxLayout(self.new_frame2)
...
def main(top_block_cls=Terminal, options=None):
    ...
    # Access width and height of the screen
